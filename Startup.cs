...
using KenticoCloudLocalizationDemo.Resolvers;
using KenticoCloudLocalizationDemo.Services;
...
namespace KenticoCloudLocalizationDemo
{
    public class Startup
    {
        // This constant must match <UserSecretsId> value in KenticoCloudLocalizationDemo.csproj 
        public const string USER_SECRETS_ID = "KenticoCloudLocalizationDemo";
